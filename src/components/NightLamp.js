    ...
    <div aria-hidden="true" className="pointer-events-none fixed inset-0 z-[5]">
      ...
      <div className="absolute right-[6vw] top-0 sm:right-[9vw] lg:right-[12vw]">
        <div className="lamp-sway flex flex-col items-center">
          <div className="h-3 w-px bg-paper/25" />
          <svg width="120" height="176" viewBox="0 0 120 176" fill="none" aria-hidden="true">
            <defs>
            ...
            />
            <circle cx="60" cy="17" r="2.5" stroke="rgba(242, 233, 216, 0.4)" strokeWidth="1.5" />

            {/* chain links */}
            <g stroke="rgba(242, 233, 216, 0.4)" strokeWidth="1.5">
            ...
            <path
              ...
              strokeLinejoin="round"
            />
            <g stroke="rgba(242, 233, 216, 0.25)" strokeWidth="1.5">
            ...
            {/* glowing Edison bulb with a visible filament */}
            <circle
              cx="60"
              cy="128"
              r="9"
              fill="rgb(255 218 150)"
              stroke="rgba(255, 196, 120, 0.85)"
              strokeWidth="1.5"
            />
            <path
              d="M56 126 q2 -4 4 0 q2 4 4 0"
              stroke="rgb(201 123 93)"
              strokeWidth="1.5"
              strokeLinecap="round"
            />
            <path
